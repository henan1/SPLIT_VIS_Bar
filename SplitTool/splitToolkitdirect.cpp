...
//    cerr<<"done"<<endl;
    ...
    //delete [] str;	
        ...
        configproperty.directproperty.UnitHeight = 1e+6;
        configproperty.directproperty.width = 20;

        configproperty.splitproperty.expHeight = -1;
        configproperty.splitproperty.coeHeight = 1;
        configproperty.splitproperty.expWidth = 5;
        ...
        configproperty.barproperty.circlecolor[0]=227./255.;//118./255;//227./255.;
        configproperty.barproperty.circlecolor[1]=218./255.;//206./255.;//218./255.;
        configproperty.barproperty.circlecolor[2]=87./255.;//58./255.;//87./255.;
